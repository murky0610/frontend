...
export default function ModalAddRepository({ open, onClose, onSuccess }: ModalAddRepositoryProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <Card className="w-full max-w-4xl shadow-lg rounded-lg">
        <CardHeader>{/* Header remains the same */}</CardHeader>
        <CardContent>
          <form>
              ...
              <div className="flex flex-row gap-8">
                ...
                <div className="w-48 space-y-1.5">
                  ...
                  >
                      ...
                      {formData.select_category ? (
                        <div className="flex items-center gap-2">
                          {categoryIcons[formData.select_category] &&
                            React.createElement(categoryIcons[formData.select_category], {
                              className: 'w-4 h-4',
                            })}
                    ...
                    <SelectContent>{renderSelectItems(categoryIcons)}</SelectContent>
                  </Select>
                ...
                <div className="w-48 space-y-1.5">
                  ...
                  >
                      ...
                      {formData.select_focus ? (
                        <div className="flex items-center gap-2">
                          {focusIcons[formData.select_focus] &&
                            React.createElement(focusIcons[formData.select_focus], {
                              className: 'w-4 h-4',
                            })}
                    ...
                    <SelectContent>{renderSelectItems(focusIcons)}</SelectContent>
                  </Select>
                ...
                <div className="w-48 space-y-1.5">
                  ...
                  >
                      ...
                      {formData.select_commodity ? (
                        <div className="flex items-center gap-2">
                          {commodityIcons[formData.select_commodity] &&
                            React.createElement(commodityIcons[formData.select_commodity], {
                              className: 'w-4 h-4',
                            })}
                    ...
                    <SelectContent>{renderSelectItems(commodityIcons)}</SelectContent>
                  </Select>
