...
export default function NavigationBarAuth() {
  ...
  const router = useRouter();
    ...
    >   <Home/>Home</DropdownMenuItem>
             <DropdownMenuItem onClick={() => setIsUserProfileOpen(true)}><UserRound/>Profile</DropdownMenuItem>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="firstName" defaultValue={editFirstName} className="col-span-3" 
              onChange={(e) => setEditFirstName(e.target.value)} 
              />
              <Label htmlFor="name" className="text-right">
                Last Name
              </Label>
              <Input id="lastName" defaultValue={editLastName} className="col-span-3" 
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="email" defaultValue={editEmail} className="col-span-3" 
