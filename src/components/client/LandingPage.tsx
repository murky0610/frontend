          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The Agri-Aqua Value Chain (AAVC) represents the complete ecosystem of activities,
                processes, and stakeholders involved in bringing agricultural and aquatic products
                from production to consumption.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Our integrated approach connects farmers, fishers, processors, distributors, and
                consumers in a sustainable network that enhances food security, promotes economic
                growth, and ensures environmental stewardship across the entire value chain.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-green-50 rounded-xl transition-all duration-300 hover:shadow-lg">
              ...
              <p>
                Directly drives progress in SDG 9 (Industry & Innovation) through technological
                development, while supporting SDG 2 (Hunger) via improved agricultural practices and
                SDG 12 through sustainable production research.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-green-50 rounded-xl transition-all duration-300 hover:shadow-lg">
              ...
              <p>
                Addresses SDG 1 (Poverty) through economic growth, SDG 10 (Inequality) via inclusive
                systems, and SDG 12 by promoting responsible resource use in production cycles.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-green-50 rounded-xl transition-all duration-300 hover:shadow-lg">
              ...
              <p className="font-bold text-gray-800 leading-relaxed">SERVE AS A LEADING HUB:</p>
              <p>
                Fulfills SDG 17 (Partnerships) through collaboration, SDG 9 by building knowledge
                infrastructure, and SDG 2 via disseminating hunger-alleviation strategies across
            ...
            <div className="lg:col-span-2">
              <div className="rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6 bg-white">
                  ...
                  >
                    UPLB 4th Global Agribusiness Management and Entrepreneurship Conference and Expo
                    (GAME 2024) DOST-PCAARRD-led Parallel Session
                  </Link>
                  <p className="text-gray-500 mt-2">16 January, 2025</p>
                  <p className="mt-3 text-gray-700">
                    The Development Innovations and Policy Laboratory launched its Mentoring Program
                    on Policy Analysis and Policy Research Proposal Development...
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <Link
                    ...
                    className="text-2xl font-bold text-green-600 hover:text-green-700 hover:underline"
                  >
                    SMAARRDEC 37th Regional Symposium on Research, Development and Extension
                    Highlights
                  </Link>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <Link
                    ...
                    className="text-2xl font-bold text-green-600 hover:text-green-700 hover:underline"
                  >
                    17th UP Mindanao Supply Chain Management Forum: Sustainable Growth and
                    Optimization in Agricultural Value Chains
                  </Link>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 flex flex-col items-center">
          ...
          <p className="mt-4 text-base text-gray-200 text-center max-w-xl">
            Empower our agri-aqua communities by supporting advanced research and innovation at the
            AAVC Lab—together, let’s shape resilient value chains.
          </p>
