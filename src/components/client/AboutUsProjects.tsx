      ...
      <div className="space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">
            Enhancing the Value Chain Project
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            For Coffee, Cacao, and Cavendish Banana Towards the Development of Agri-Aqua Value Chain
        ...
        <Card className="border-t-4 border-t-emerald-500">
          ...
          <CardContent className="prose prose-emerald max-w-none">
            <p>
              This program will contribute to new ways of evaluation that account for the dynamics
              in the chain and develop models to aid decision-making and develop more effective
              upgrading strategies considering emerging and critical concerns like sustainability,
              resiliency and inclusiveness. Build on the findings of previous initiatives of UP
              Mindanao related to cacao, coffee, and cavendish banana Based on the program's
              findings, a framework for other commodity chains may be established and used as the
              basis for intervention.
            </p>
            <p>
              Institutional innovation can be developed for developing effective link of value chain
              design and implementation (e.g., VC Lab). Innovative ways to evaluate value chains
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                Agri-food chain applications for decision-making (i.e., prototype mobile apps)
              </li>
              ...
              <Card className="border-t-4 border-t-emerald-500">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-lg">
                    Cacao, Coffee, and Cavendish Banana
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-8">
                  <div className="bg-emerald-50 p-6 rounded-lg">
                    <p className="text-gray-700 leading-relaxed">
                      For the three chains, updating includes utilizing previous survey data to
                      examine the role of consolidation and clusters. Factors affecting the decision
                      to cluster will be examined using a logit model. A technical efficiency model
                      will also be estimated to analyze the role of clusters in enhancing
                      efficiency. A new survey will be conducted for cacao which will be used in
                      agent-based modelling in component 2 as well as in the analysis of clusters.
                      Training and workshops on value chain analysis and development will be
                      conducted for a selected group of researchers and practitioners. Stakeholder
                      workshops will also be conducted to present research outputs. These
                      capacity-building activities and stakeholder engagement form part and parcel
                      of developing a value chain laboratory for the agri-food sector.
                    </p>
                  </div>
                ...
                <CardContent className="space-y-6">
                  <div className="bg-emerald-50 p-6 rounded-lg">
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      decision-making and evaluation of the chain. This project will focus on
                      developing models of at most three chains: Cavendish banana, coffee, and
                      cacao. Studying these value chains in UP Mindanao is not new. However, this
                      project aims to incorporate the data gathered from previous studies
                      ...
                      projects for cacao value chain) to develop further models that will support in
                      the improvement of the studied chains.
                    </p>
                  </div>
            ...
            <TabsContent value="project3">
              <Card className="border-t-4 border-t-emerald-500">
                ...
                <CardContent className="space-y-6">
                  <div className="bg-emerald-50 p-6 rounded-lg">
                    <p className="text-gray-700 leading-relaxed">
                      This project covers the data analytics component of the proposed program. It
                      will build on the updated analysis of the banana (Cavendish banana), cacao,
                      and coffee value chains by developing decision support platform based on an
                      analysis of issues in the value chains, previous outputs of mathematical
                      models (e.g., SCND), previous technologies developed (e.g., Kape Analytics),
                      and data analytics modules for selected crops. The technologies will be tested
                      and built as a validated prototype. The prototype testing will include testing
                      with small-scale farmers of the selected crops to validate model results and
                    ...
                    <p className="text-gray-700 leading-relaxed mt-4">
                      ...
                      farm-level. Trainings and workshops will be conducted for its users.
                      Technology pitch can be created to drum up investment support from potential
                      investors. Project 3 will contribute to the large gap in A4.0 technologies in
