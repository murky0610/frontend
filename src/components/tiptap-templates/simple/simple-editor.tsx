...
const MainToolbarContent = ({
  ...
  onLinkClick,
  isMobile,
  onSaveClick, // Add new prop
}: {
  onHighlighterClick: () => void;
  onLinkClick: () => void;
  isMobile: boolean;
  onSaveClick: () => void; // Add prop type
}) => {
  return (
    <>
      <Spacer />
      ...
      <ToolbarGroup>
        ...
        <Button onClick={onSaveClick}>Save</Button> {/* Add click handler */}
      </ToolbarGroup>
...
export function SimpleEditor() {
  ...
  const handleSave = () => {
    ...
    a.href = url;
    a.download = 'document.txt'; // Default file name
      ...
      >
        {mobileView === 'main' ? (
          <MainToolbarContent
            ...
            isMobile={isMobile}
            onSaveClick={handleSave} // Pass the handler
          />
        ) : (
