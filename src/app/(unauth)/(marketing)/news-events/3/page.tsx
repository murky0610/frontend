...
export default function Page3rdNews() {
  const item = {
    id: 1,
    title: "17th UP Mindanao Supply Chain Management Forum: Sustainable Growth and Optimization in Agricultural Value Chains",   
