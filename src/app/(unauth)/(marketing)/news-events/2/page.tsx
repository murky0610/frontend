...
export default function Page2ndNews() {
  const item = {
    ...
    description:
    <>
     <p className="indent-8 mb-4">During the Southern Mindanao Agriculture, Aquatic and Natural Resources Research & Development Consortium (SMAARRDEC) 37th Regional Symposium on Research, Development and Extension Highlights Mr. Mark James Saguimpa submitted the abstract of the study “The Effect of Elevation on the Technical Efficiency of Robusta Coffee Farmers in Sultan Kudarat, Philippines” for the Research Category, which was eventually featured in the Book of Abstracts. Other researchers, Ms. Alessa Keith E. Carbonell and Mr. Jeff Erxon B. Palen were also present during the event, as shown in Figure 21.
     </p>
     <p className="indent-8 mb-4">
         Meanwhile, Ms. Novy Aila B. Rivas competed for the Poster Category, explaining her study “Identifying Optimal Market Choices to Increase the Profitability of Coffee Farmers in Sultan Kudarat through Modeling and Scenario Analysis.” The poster highlights that the coffee farmers’ profitability is significantly influenced by product pricing in different markets, the coffee product choice to sell, and the value-adding costs. It is recommended to produce high-quality beans to increase market opportunities, secure higher prices, and reduce processing costs.
         </p>
    </>,
